...
export const metadata = {
  title: 'Privacy Policy | H-Prime Gym Equipment Repair',
  description: 'Privacy policy for H-Prime Gym Equipment Repair. Learn how we collect, use, and protect your personal information.',
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>
                {BUSINESS_NAME}, operated by H-Prime Gym Equipment Repair LLC ("we," "us," or "our"), respects your 
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Provide, maintain, and improve our gym equipment repair services</li>
            ...
            <section>
              ...
              <p>
                ...
                H-Prime Gym Equipment Repair LLC<br />
                CO<br />
