...
export const metadata = {
  title: 'California Notice at Collection | H-Prime Gym Equipment Repair',
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>
                ...
                It describes how {BUSINESS_NAME}, operated by H-Prime Gym Equipment Repair LLC, collects, uses, and 
            ...
            <section>
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="border-l-4 border-orange-600 pl-4">
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    <strong>Examples:</strong> Gym equipment repair history, service quotes, invoices
                  </p>
                </div>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Providing gym equipment repair services</li>
