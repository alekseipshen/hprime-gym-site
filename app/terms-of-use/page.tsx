...
export const metadata = {
  title: 'Terms of Use | H-Prime Gym Equipment Repair',
  description: 'Terms and conditions for using H-Prime Gym Equipment Repair website and services.',
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>
                {BUSINESS_NAME}, operated by H-Prime Gym Equipment Repair LLC, provides gym equipment repair services 
